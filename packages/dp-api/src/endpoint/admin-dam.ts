...
export const GetDamsApi = async() => {
    const res = await api.post(`/docpal/dam/getAllSetting`).then(res => res.data.data)
...
export const AddDamApi = async(params: any) => {
    return await api.put('/docpal/dam/setting', params).then(res => res.data.data)
}
export const EditDamApi = async(params: any) => {
    return await api.post('/docpal/dam/editSetting', params).then(res => res.data.data)
}
export const DeleteDamApi = async(params: string[]) => {
    return await api.post('/docpal/dam/deleteSettings', params).then(res => res.data.data)
}
