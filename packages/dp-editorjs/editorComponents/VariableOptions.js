...
export default class VariableOptions {
    ...
    showActions(mark) {
        ...
        this.colorPicker.value = backgroundColor ? this.convertToHex(backgroundColor) : '#000';
