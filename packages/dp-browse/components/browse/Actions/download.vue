...
<template>
  ...
  <BrowseActionsButton id="downloadActionButton" :label="$t('tip.download')" @click="popupOpened = true">
            <SvgIcon src="/icons/file/download.svg" round :content="$t('tip.download')"
                        ></SvgIcon>
  </BrowseActionsButton>
