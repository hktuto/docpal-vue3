        ...
        <main>
            <FolderCabinetTable ref="tableRef" @row-click="handleRowClick">
                <template #suffixSortButton>
                    <el-button data-testid="folderCabinet-new-button" @click="handleNewItem()">{{$t('folderCabinet.newItem')}}</el-button>
                    <!-- <el-button class="suffixSortButton" @click="handleNextItem()">{{$t('handleNextItem.newItem')}}</el-button> -->
                    <el-button type="info" data-testid="folderCabinet-export-button" @click="handleDownload()">{{$t('export')}}</el-button>
